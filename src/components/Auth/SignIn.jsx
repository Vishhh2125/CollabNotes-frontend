...
export function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Dispatch login action - Redux handles loading, error, and success states
    console.log("Dispatching login with data:", formData);
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0e1018] to-[#0b0d14] text-white flex items-center justify-center relative">
      ...
      <div className="w-full max-w-md rounded-xl bg-[#121421] backdrop-blur-sm border border-indigo-400/25 p-8 relative z-10 shadow-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold">Sign in to CollabNotes</h1>
          <p className="text-slate-400 text-sm mt-2">Access your notes securely</p>
        </div>
